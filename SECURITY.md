...
`execFile`/`spawn` without a shell. If you find a code path where
project-controlled input reaches a shell, a network endpoint, or a file write
outside the workspace, that is in scope for this policy.
